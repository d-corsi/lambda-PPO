...
if __name__ == "__main__":
	...
	# parser.add_argument("--standardize-advantages", type=int, default=1)
	...
	# Corsi et al. flags
	# parser.add_argument("--use-corsi", type=int, default=0)
	...
	parser.add_argument("--test-0", type=int, default=1) # 0: Naive, 1: Standardized ADV, 2: Normalized ADV
	parser.add_argument("--test-1", type=int, default=0) # 0: Adam, 1: SGD, 2: NoGrad, 3: PID 
	parser.add_argument("--test-2", type=int, default=2) # 0: Softplus, 1: Clip, 2: Corsi  
	...
	# Adding specific paramters for pedagocic implementation
	if args.test_1 == 3:
		args.PID_integrative = 0
		args.PID_old_cost = 0
